          ...
          {acctHoldings.length > 0 ? (
            ...
            <Card>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 text-xs mt-1">Balance: {formatCurrency(account.current_balance ?? 0)}</p>
              </div>
            </Card>
          )}
        </>
              ...
              <div className="divide-y divide-[#2a2d3d]/50">
                {group.accounts.map((acct) => (
                  <div
                    ...
                    className="px-5 py-4 flex items-center justify-between hover:bg-[#252839] transition-colors cursor-pointer"
                  >
                    <div>
                    ...
                    <div className="text-right">
                      <p className="text-sm font-semibold text-white">{formatCurrency(acct.current_balance ?? 0)}</p>
                      {acct.available_balance != null && acct.available_balance !== acct.current_balance && (
                        <p className="text-xs text-gray-500">{formatCurrency(acct.available_balance)} available</p>
                      )}
                    </div>
                  </div>
                ))}
...
export function Accounts() {
  ...
  return accountId ? <AccountDetail accountId={accountId} /> : <AccountList />
}
